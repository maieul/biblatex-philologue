...
\DeclareLabelname[book, bookinbook, bookinarticle]{\field{author}}


\renewbibmacro*{date}{\printdate\iffieldundef{origyear}{}{\addspace\mkbibparens{\bibstring{reprint}%
